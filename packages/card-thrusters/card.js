...
Template.card_thrusters.helpers({
  manualThrustersRequired: function () {
    ...
    if (requiredThrusters.yaw !== currentThrusters.yaw || requiredThrusters.pitch !== currentThrusters.pitch || requiredThrusters.roll !== currentThrusters.roll && Flint.system('Thrusters','manualThruster') == 'true') {
      return "active";
    } else {
      return '';
    }
